...
from transformers import AutoModelForCausalLM, AutoTokenizer, Gemma3ForCausalLM, Gemma3ForConditionalGeneration
...
def train(
    ...
    # model = Gemma3ForCausalLM.from_pretrained(base_model, device_map={"": 0}, attn_implementation='eager', torch_dtype=torch.bfloat16)
